...
- ALU reads the contents of registers A ad B, adds them together, and places result into register A)
...
**What happens:**
- Load the contents of memory location 0x80 (current value of variable A) into register A 
- Compare the contents of register A with the literal value 100 (0x64 hex)
- If the comparison shows A < 100, jump back to label L30 (continue the loop) if not continue to L70
